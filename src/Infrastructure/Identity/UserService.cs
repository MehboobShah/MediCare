...
using MediCare.Application.Common.Caching;
using MediCare.Application.Common.Events;
using MediCare.Application.Common.Exceptions;
using MediCare.Application.Common.FileStorage;
using MediCare.Application.Common.Interfaces;
using MediCare.Application.Common.Mailing;
using MediCare.Application.Common.Models;
using MediCare.Application.Common.Specification;
using MediCare.Application.Identity.Users;
...
namespace MediCare.Infrastructure.Identity;
